...
- O cliente OAuth Google, a GitHub App limitada ao repositório e os seis secrets do ambiente Production foram configurados; o callback Google foi validado com a conta autorizada e o painel abriu as três coleções após a emissão do token de instalação.
